...
struct ImGuiContext
{
    ...
    int                     DragDropAcceptFrameCountActual;     // 目前引擎中的 DragDrop 是延迟接受的，这是实际的接受帧
...
//#endif
    ...
    IMGUI_API void          RenderDragDropTargetRect(const ImRect& bb, const ImRect& item_clip_rect, bool render_as_line = false);
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool borders = true, float rounding = 0.0f, ImDrawFlags drawFlags = ImDrawFlags_None);
    ...
    // Widgets
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, ImDrawFlags frameDrawFlags = ImDrawFlags_None);
